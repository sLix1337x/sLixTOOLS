...
const ConvertCaseTool: React.FC = () => {
  ...
  const convertToSentenceCase = useCallback(() => {
    const converted = inputText.toLowerCase().replace(/(^|[.!?]\s*)([a-z])/g, (match, p1, p2) => p1 + p2.toUpperCase());
    setInputText(converted);
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      <Helmet>
        <title>Convert Case Tool - sLixTOOLS</title>
        <meta name="description" content="Convert text between different cases: lowercase, UPPERCASE, Capitalized Case, Sentence case, and aLtErNaTiNg cAsE." />
        <meta name="keywords" content="text case converter, uppercase, lowercase, capitalize, sentence case, alternating case" />
      </Helmet>
        ...
        <AnimatedElement>
          <div className="text-center mb-6">
            <div className="flex items-center justify-center mb-4">
              <Type className="h-12 w-12 text-blue-400 mr-3" />
              <h1 className="text-4xl font-bold text-white">Convert Case Tool</h1>
            </div>
